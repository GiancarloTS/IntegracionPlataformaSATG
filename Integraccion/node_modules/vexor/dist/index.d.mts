...
interface VexorRetrieveResponse {
    message: string;
    identifier: string;
    raw: any;
}
...
declare const vexorRetrieve: (vexor: any) => ((params: {
    platform: SupportedVexorPlatform;
} & VexorRetrieveBody) => any) & {
    mercadopago: (body: VexorRetrieveBody) => any;
    stripe: (body: VexorRetrieveBody) => any;
    paypal: (body: VexorRetrieveBody) => any;
    talo: (body: VexorRetrieveBody) => any;
    square: (body: VexorRetrieveBody) => any;
};
...
declare class Vexor {
   ...
   */
     ...
     * Facilitates refund processing for various payment platforms.
     */
    retrieve: ReturnType<typeof vexorRetrieve>;
    createRetrieve(platform: SupportedVexorPlatform, body: VexorRetrieveBody): Promise<VexorRetrieveResponse>;
    private setApiUrl;
}
